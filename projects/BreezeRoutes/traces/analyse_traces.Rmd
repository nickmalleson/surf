...
```{r rerunAsymmetryAnalysis-absoluteLengths, cache=TRUE, eval=FALSE }
# This repeasts the code in `make matrix` chunk
...
```{r recalculateAsymmetry-absoluteLengths, cache=TRUE, eval=FALSE}
...
Asymettry values:
 ...
 - XXXX Longest asymetry: `r result1.percentage.asymmetry.weekday`

 - XXXX Shortest asymetry: `r result1.percentage.asymmetry.weekend`
...
```{r AV.asymmetry.analysis, cache=FALSE }
