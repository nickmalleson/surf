...
for (ncells in sen.resolutions) {
  ...
  # XXXX CALCULATE (A)SYMMETRY STATISTICS 
...
save(sen.resolutions, sen.grids, sen.results, sen.results.spdf, sen.results.matrix, file="sen_results.RData")


save.image(file="analyse_traces-temp.RData") # For debugging
```

Now analyse them. Start with a graph of 
