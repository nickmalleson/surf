...
The percentage asymmetry is `r round(percentage.asymmetry,3) * 100`%. Therefore asymmetric flows account for `r round(percentage.asymmetry) * 100`% of all flows, or people change their routes `r round(percentage.asymmetry) * 100`% of the time.
