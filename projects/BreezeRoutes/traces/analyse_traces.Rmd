...
for (cell in seq(1, total.cells)) {
  ...
  total.flow <- c(total.flow, result1[,cell]@data$total.intersection)
...
par(mfrow=c(1,2))
hist(rel.flow, breaks="Scott", main="Distribution of relative flows")
hist(rel.flow/total.flow, breaks="Scott", main="Proportional relative flows")
