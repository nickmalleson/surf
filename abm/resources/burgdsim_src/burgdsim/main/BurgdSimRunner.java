...
public class BurgdSimRunner extends AbstractRunner {

	private static MessageCenter msgCenter = MessageCenter.getMessageCenter(BurgdSimRunner.class);
