...
acts <- read.csv('agent-activities.csv')
...
Plot the overeall intensities of the different activities.
...
Plot a combination of overall intensity, background intensity, and time-related intensity
