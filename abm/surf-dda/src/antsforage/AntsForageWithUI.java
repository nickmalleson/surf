...
public class AntsForageWithUI extends GUIState
    ...
    public static void main(String[] args)
        {
        new sim.app.antsforage.AntsForageWithUI().createController();
        }
    
    public AntsForageWithUI() { super(new sim.app.antsforage.AntsForage(System.currentTimeMillis())); }
    ...
    public void setupPortrayals()
        {
        sim.app.antsforage.AntsForage af = (sim.app.antsforage.AntsForage)state;

        // tell the portrayals what to portray and how to portray them
        homePheromonePortrayal.setField(af.toHomeGrid);
        homePheromonePortrayal.setMap(new sim.util.gui.SimpleColorMap(
                0,
                sim.app.antsforage.AntsForage.LIKELY_MAX_PHEROMONE,
